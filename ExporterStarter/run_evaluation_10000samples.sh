...
python ExportManager.py --config=num_samples_config.yml --targets=200 --timeseries=70000 --windowsize=10000 --querytype=sum --waiteval=100
...
python ExportManager.py --config=num_samples_config.yml --targets=200 --timeseries=70000 --windowsize=10000 --querytype=avg --waiteval=100
...
python ExportManager.py --config=num_samples_config.yml --targets=200 --timeseries=70000 --windowsize=10000 --querytype=quantile --waiteval=300
