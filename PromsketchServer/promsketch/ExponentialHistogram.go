...
func (ehkll *ExpoHistogramKLL) Cover(mint, maxt int64) bool {
	...
	// isCovered := ehkll.max_time[ehkll.s_count-1] >= maxt
	isCovered := ehkll.max_time[ehkll.s_count-1] >= maxt && ehkll.min_time[0] <= mint // && ehkll.max_time[ehkll.s_count-1]-ehkll.time_window_size <= mint
	ehkll.mutex.RUnlock()
	return isCovered
